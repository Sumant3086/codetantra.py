...
Constructor: The constructor must have a special name __init__() and a special parameter called self. In Python, the constructor is invoked automatically whenever a new object of a class is instantiated.
